    ...
    <div className="h-screen flex flex-col bg-[#0a0a0b] text-white font-sans overflow-hidden">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 flex items-center justify-center relative overflow-hidden">
          <div style={{ perspective: params['Perspective'], perspectiveOrigin: '58% 50%', width: 560, height: 560, display: 'flex', alignItems: 'center', justifyContent: 'center', transform: `scale(${Math.min(0.85, 300 / (items.length * params['Page Spacing'] * 0.9)).toFixed(3)})` }}>
